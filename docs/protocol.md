        # Maworkbench: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/maworkbench.git

        ## Objective

        MAWorkbench is an integrated meta-analysis workbench providing a unified interface for data import, effect-size calculation, pooling, heterogeneity assessment, and reporting.
        ...
        - Code: https://github.com/mahmood726-cyber/maworkbench.git
